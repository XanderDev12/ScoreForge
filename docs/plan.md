...
1. Initialize the React project tooling.
2. Decide the asset-serving strategy for `MusicData/`.
3. Make Catalog the default landing view.
4. Build the first catalog list from `scores.json`.
5. Add View, Download MusicXML/MXL, and Download PDF actions.
6. Connect catalog selection to the shared score viewer.
7. Add the initial Uploads section once the catalog flow works.
